...
public class VisitableSequence extends Sequence implements VisitableVisitor {
	...
	switch (i) {
	case 0: return (VisitableVisitor) first;
	case 1: return (VisitableVisitor) then;
	default: throw new IndexOutOfBoundsException();
	}
    }
    public Visitable setChildAt(int i, Visitable child) {
	switch (i) {
	case 0: first = (VisitableVisitor) child; return this;
	case 1: then  = (VisitableVisitor) child; return this;
	default: throw new IndexOutOfBoundsException();
	}
    }
